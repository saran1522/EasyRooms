      ...
      <div className="flex-grow px-6 py-3 flex flex-col">
        <div className="flex items-center justify-between">
          ...
          {isPast(new Date(startDate)) ? (
            <span className="bg-red-500 text-primary-50 h-7 px-3 uppercase text-xs font-bold flex items-center rounded-sm">
              past
            </span>
          ) : (
            <span className="bg-accent-950 text-primary-50 h-7 px-3 uppercase text-xs font-bold flex items-center rounded-sm">
              upcoming
            </span>
          )}
        </div>
